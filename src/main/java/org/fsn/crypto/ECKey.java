...
public class ECKey implements Serializable {
    ...
    private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
        if(priv == null) {
            ...
            try {
                return ECKeyFactory.getInstance(SpongyCastleProvider.getInstance()).generatePrivate(new ECPrivateKeySpec(priv, CURVE_SPEC));
    ...
    public BigInteger keyAgreement(ECPoint otherParty) {
        if(this.privKey == null) {
            ...
            agreement.init(new ECPrivateKeyParameters(((BCECPrivateKey)this.privKey).getD(), CURVE));
            ...
            try {
                ...
                agreement.doPhase(ECKeyFactory.getInstance(this.provider).generatePublic(new ECPublicKeySpec(otherParty, CURVE_SPEC)), true);
    ...
    public static boolean verify(byte[] data, ECKey.ECDSASignature signature, byte[] pub) {
        ...
        try {
            ...
            logger.error("Caught NPE inside bouncy castle", var6);
            return false;
        }
    }
    ...
    public static class ECDSASignature {
        ...
        public static ECKey.ECDSASignature decodeFromDER(byte[] bytes) {
            ...
            try {
                ...
                var5 = new ECKey.ECDSASignature(r.getPositiveValue(), s.getPositiveValue());
        ...
        public byte[] toByteArray() {
            ...
            return ByteUtil.merge(new byte[][]{ByteUtil.bigIntegerToBytes(this.r), ByteUtil.bigIntegerToBytes(this.s), {fixedV}});
        }
